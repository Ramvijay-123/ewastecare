let APP_ID = "6155f162240b4d71ba96d19e56f8af51"
...
if (!roomId) {
    window.location = 'chatroom' // if not having room ID
}

let localStream // audio and video data of local user
let remoteStream // audio and video data of the remote user
let peerConnection // interface that store all info between you and the remote 
